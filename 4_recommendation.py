...
def recommendation_content_based(engine):
    ...
    for row_index in tqdm(range(cosine_similarities.shape[0]), desc = 'Model 2: Content Based'):
        top_related_rows = cosine_similarities[row_index].argsort()[-2:-22:-1].tolist()
